...
- See instructions/nextjs.instructions.md for Next.js best practices and project structure.
- See instructions/nextjs-tailwind.instructions.md for Tailwind CSS and styling standards.
...
// ...existing code examples from expert-nextjs-developer.agent.md...
